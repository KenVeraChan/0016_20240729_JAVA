...
// introducir, pida esos números, y muestre un mensaje cada 
// vez que un número no sea mayor queel anterior.

package bucle_For;
import java.util.Scanner;
public class P004_Mayores_Que_El_Anterior {
	...
	public static void main(String[] args) {
		...
		for(puntero=2;puntero<=contabilidad;puntero++)
		{
			...
			if(valor_2>valor_1 && activador!=0)
			{	
				valor_1=valor_2;    //Se pasa el relevo al siguiente numero mayor que se había introducido
				System.out.println("Introduzca un numero mayor que "+valor_1);
				valor_2=numeros.nextInt();
			}
