// Amplíe el programa anterior, de manera que el programa declare ganador al 
// jugador que haya obtenido más puntos sin superar 20 puntos.

package bucle_While;
import java.util.Scanner;
public class P015_Juego_Los_Veinte_Parte_5 {
	public static void main(String[] args) {
		...
		if(total_jugador_1>total_jugador_2)
		{
			...
			if(total_jugador_1<=20 && total_jugador_2<=20)
			{
			...
			if(total_jugador_1>20 && total_jugador_2>20)
			{
			System.out.println("No gana nadie por superar los 20 puntos");
			}
		}
		if(total_jugador_1<total_jugador_2)
		{
		...
		if(total_jugador_1==total_jugador_2 && activado==1 && total_jugador_1<=20 && total_jugador_2<=20)
