       ...
       if(caracter.equals("+") || caracter.equals("-") || caracter.equals("*") || caracter.equals("/") || caracter.equals("R")|| caracter.equals("="))
          ...
          if(caracter.equals("="))
          {
              if(signo.equals("+"))
              {
	              ...
	              if(resultadoIntermedio.isEmpty())
	              {
                     resultadoOperacion=resultadoOperacion+Double.parseDouble(sentencia);
              ...
              {
                  registro=0;  //SE DESACTIVA PARA TRABAJAR CON LA SIGUIENTE OPERACION
                  //EN EL CASO DE QUE SEA UNA RESTA  
                  if(resultadoIntermedio.isEmpty())
                  {
                     resultadoOperacion=resultadoOperacion-Double.parseDouble(sentencia);
                     pantalla.setText(String.format("%.3f",resultadoOperacion));
              ...
              {
                  registro=0;  //SE DESACTIVA PARA TRABAJAR CON LA SIGUIENTE OPERACION
                  //EN EL CASO DE QUE SEA UNA MULTIPLICACION  
                  if(resultadoIntermedio.isEmpty())
                  { 
                     resultadoOperacion=resultadoOperacion*Double.parseDouble(sentencia);
                     pantalla.setText(String.format("%.3f",resultadoOperacion));
              ...
              {
	              registro=0;  //SE DESACTIVA PARA TRABAJAR CON LA SIGUIENTE OPERACION
	              //EN EL CASO DE QUE SEA UNA DIVISION  
	              if(resultadoIntermedio.isEmpty())
	              {
                     resultadoOperacion=resultadoOperacion/Double.parseDouble(sentencia);
                     pantalla.setText(String.format("%.3f",resultadoOperacion));
